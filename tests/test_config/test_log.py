...
from cambiato.config import log
...
class TestFileLogHandler:
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                './Cambiato_test.log',
                (Path() / 'Cambiato_test.log').resolve(),
                id='relative_path',
            ),
            pytest.param(
                '~/Cambiato_test.log',
                (Path.home() / 'Cambiato_test.log').expanduser(),
                id='expanduser',
            ),
        ],
    )
    ...
    def test_log_dir_created(self, tmp_path: Path) -> None:
        ...
        path = mocked_log_dir / 'Cambiato.log'
